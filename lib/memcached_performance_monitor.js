...
metrics['Threads'] 			   = { id: '9999:Threads:4', 				key : 'threads', 			rate : false };
metrics['CurrentItems'] 	   = { id: '9999:Current Items:4', 			key : 'curr_items', 		rate : false };
metrics['TotalItems'] 		   = { id: '9999:Total Items:4', 			key : 'total_items', 		rate : false };
metrics['StoreLimit'] 		   = { id: '9999:Limit Maxbytes:4', 		key : 'limit_maxbytes', 	rate : false, transform : function(v) { return v / 1024 / 1024; } };
metrics['StoreUsage'] 		   = { id: '9999:Store Usage:4', 			key : 'bytes', 				rate : false, transform : function(v) { return v / 1024 / 1024; } };
metrics['CurrrentConnections'] = { id: '9999:Currrent Connections:4', 	key : 'curr_connections', 	rate : false };

metrics['BytesRead/Sec'] 	= { id: '9999:Bytes Read/Sec:4', 	key : 'bytes_read', 		rate : true, transform : function(v) { return v / 1024 / 1024; } };
metrics['BytesWritten/Sec'] = { id: '9999:Bytes Written/Sec:4', key : 'bytes_written', 		rate : true, transform : function(v) { return v / 1024 / 1024; } };
metrics['Connections/Sec'] 	= { id: '9999:Connections/Sec:4', 	key : 'total_connections', 	rate : true };
metrics['Gets/Sec'] 		= { id: '9999:Gets/Sec:4', 			key : 'cmd_get', 			rate : true };
metrics['Sets/Sec'] 		= { id: '9999:Sets/Sec:4', 			key : 'cmd_set', 			rate : true };
metrics['GetHits/Sec'] 		= { id: '9999:Get Hits/Sec:4', 		key : 'get_hits', 			rate : true };
metrics['GetMisses/Sec'] 	= { id: '9999:Get Misses/Sec:4', 	key : 'get_misses', 		rate : true };
metrics['DeleteHits/Sec'] 	= { id: '9999:Delete Hits/Sec:4', 	key : 'delete_hits', 		rate : true };
metrics['DeleteMisses/Sec'] = { id: '9999:Delete Misses/Sec:4', key : 'delete_misses', 		rate : true };
metrics['IncrHits/Sec'] 	= { id: '9999:Incr Hits/Sec:4', 	key : 'incr_hits', 			rate : true };
metrics['IncrMisses/Sec']	= { id: '9999:Incr Misses/Sec:4', 	key : 'incr_misses', 		rate : true };
metrics['DecrHits/Sec'] 	= { id: '9999:Decr Hits/Sec:4', 	key : 'decr_hits', 			rate : true };
metrics['DecrMisses/Sec'] 	= { id: '9999:Decr Misses/Sec:4', 	key : 'decr_misses', 		rate : true };
metrics['Evictions/Sec'] 	= { id: '9999:Evictions/Sec:4', 	key : 'evictions', 			rate : true };
metrics['Reclaimed/Sec'] 	= { id: '9999:Reclaimed/Sec:4', 	key : 'reclaimed', 			rate : true };
